// Compiled with GNU-4.8.1 GCC for Linux AMD64
// cc -L/path/to/folder -shared -fPIC -Wall spectrl2.c spectrl2_2.c solpos.c \
//     -o libspectrl2.so -lsolposAM
//
// 2013 Sunpower Corp.
...
long spectrl2( int units, float *location, int *datetime,
