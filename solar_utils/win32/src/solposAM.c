// solposAM exports solposAM as a dll
//
// Compile with Windows SDK 7.0
// Note: solposAM.c, solpos.c & solpos00.h must be in the same folder
// Start the SDK shell in x64-release mode: SetEnv.Cmd /RELEASE /X64
// In the sdk shell execute: cl.exe /LD solposAM.c solpos.c
//
// 2013 Sunpower Corp.
